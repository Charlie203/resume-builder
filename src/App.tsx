      ...
      <div style={styles.mainGrid}>
        ...
        <aside style={{...styles.sidebar, backgroundColor: theme === 'dark' ? 'rgba(31, 41, 55, 0.5)' : 'rgba(255, 255, 255, 0.6)'}}>
          ...
          <div style={styles.formContainer}>
            ...
            <Section title="Skills" onAdd={() => handleAdd(setSkills, 'New Skill')}>
...
const styles: { [key: string]: CSSProperties } = {
  ...
  input: { width: '100%', padding: '10px 12px', borderRadius: '8px', border: '1px solid rgba(0,0,0,0.08)', background: 'rgba(255,255,255,0.8)', boxSizing: 'border-box' },
